...
SVC_NAME="actions.runner.Aswin-Coddletech-GH-React-Action.selr-hosted-runner"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Aswin-Coddletech-GH-React-Action.selr-hosted-runner)"
